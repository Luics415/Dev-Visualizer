  ...
  return (
    <>
      <section className="library-controls" aria-label="Filtros de colecciones">
        <label><span>Buscar tecnología o concepto</span><input type="search" value={query} onChange={(event) => setQuery(event.target.value)} placeholder="Python, Prolog, SQL Server, AWS…" /></label>
