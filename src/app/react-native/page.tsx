...
export default function ReactNativePage() {
  return (
    <main className="page-shell">
      ...
      <CollectionLibraryInvite href="/libreria/react-native" collectionName="React Native" />
        ...
        <section className="collection-section" id={slugify(section)} key={section}>
          ...
          <div className="concept-grid concept-grid--atlas" aria-label={section}>
            {reactNativeConcepts.map((concept, index) => concept.section === section ? (
              <ConceptCard key={concept.title} index={index + 1} title={concept.title} description={concept.description} collectionId="react-native" section={concept.section} family={concept.family} layout={concept.layout}>
