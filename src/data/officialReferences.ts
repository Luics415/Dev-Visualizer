...
const baseReferenceList: readonly OfficialReference[] = [
  ...
  r("iso-prolog-core", "ISO/IEC 13211-1 — Prolog core", "https://www.iso.org/standard/21413.html", "ISO/IEC", "standard", "ISO/IEC 13211-1:1995, confirmado en 2024", "Sintaxis, términos, cláusulas, ejecución, errores y portabilidad del núcleo de Prolog.", ["prolog", "término", "variable", "cláusula", "unificación", "error", "iso", "portabilidad"]),
  r("iso-prolog-modules", "ISO/IEC 13211-2 — Prolog modules", "https://www.iso.org/standard/20775.html", "ISO/IEC", "standard", "ISO/IEC 13211-2:2000", "Conceptos e interfaz de módulos; las implementaciones reales conservan diferencias de dialecto.", ["módulo", "import", "export", "namespace", "portabilidad", "dialecto"]),
  r("iso-prolog-dcg", "ISO/IEC TS 13211-3 — Definite clause grammars", "https://www.iso.org/standard/83635.html", "ISO/IEC", "standard", "ISO/IEC TS 13211-3:2025", "Notación y traducción normativa de gramáticas de cláusulas definidas.", ["dcg", "gramática", "phrase", "parser", "lista diferencia"]),
  r("swi-prolog-manual", "SWI-Prolog Reference Manual", "https://www.swi-prolog.org/download/stable/doc/SWI-Prolog-10.0.2.pdf", "SWI-Prolog Project", "primary-manual", "SWI-Prolog 10.0.2", "Lenguaje práctico, top level, built-ins, módulos, depuración, memoria, concurrencia e integración.", ["swi", "top level", "built-in", "debug", "thread", "memoria", "http", "json", "foreign", "producción"]),
  r("swi-prolog-clpfd", "SWI-Prolog CLP(FD)", "https://www.swi-prolog.org/pldoc/man?section=clpfd-intro", "SWI-Prolog Project", "official-api", "SWI-Prolog 10.0.2", "Dominios finitos, propagación, reificación, restricciones globales y labeling.", ["clp(fd)", "restricción", "dominio", "labeling", "propagación", "all_distinct"]),
  r("swi-prolog-tabling", "SWI-Prolog tabling", "https://www.swi-prolog.org/pldoc/man?section=tabling", "SWI-Prolog Project", "official-api", "SWI-Prolog 10.0.2", "Tabling por variante o subsunción, recursión izquierda, well-founded e incremental tabling.", ["tabling", "tabla", "recursión izquierda", "subsumption", "well-founded", "incremental"]),
  ...
  r("sqlserver-docs", "SQL Server technical documentation", "https://learn.microsoft.com/sql/sql-server/sql-server-technical-documentation", "Microsoft", "official-docs", "SQL Server 2025 (17.x)", "Inicio, Database Engine, instalación, administración, desarrollo, rendimiento, seguridad y continuidad.", ["sql server", "database engine", "instancia", "edición", "instal", "administr", "producción"]),
  r("sqlserver-tsql", "Transact-SQL reference", "https://learn.microsoft.com/en-us/sql/t-sql/language-reference?view=sql-server-ver17", "Microsoft", "official-api", "SQL Server 2025 (17.x)", "Sintaxis y semántica de T-SQL, tipos, consultas, escritura, control de flujo y objetos programables.", ["t-sql", "select", "join", "insert", "update", "delete", "procedure", "function", "trigger", "tipo"]),
  r("sqlserver-internals", "SQL Server internals and architecture guides", "https://learn.microsoft.com/en-us/sql/relational-databases/sql-server-guides?view=sql-server-ver17", "Microsoft", "primary-manual", "SQL Server 2025 (17.x)", "Arquitectura del motor, páginas, archivos, buffer pool, transaction log, optimizador y ejecución.", ["página", "extent", "buffer", "archivo", "filegroup", "tempdb", "log", "lsn", "checkpoint", "optimizador", "plan"]),
  r("sqlserver-locking", "Transaction locking and row versioning guide", "https://learn.microsoft.com/en-us/sql/relational-databases/sql-server-transaction-locking-and-row-versioning-guide?view=sql-server-ver17", "Microsoft", "primary-manual", "SQL Server 2025 (17.x)", "Transacciones, niveles de aislamiento, locks, versiones de fila, bloqueo y deadlocks.", ["transaction", "transacción", "lock", "aislamiento", "row version", "snapshot", "blocking", "deadlock"]),
  r("sqlserver-query-store", "Monitor performance with Query Store", "https://learn.microsoft.com/en-us/sql/relational-databases/performance/monitoring-performance-by-using-the-query-store?view=sql-server-ver17", "Microsoft", "official-docs", "SQL Server 2025 (17.x)", "Planes, estadísticas de ejecución, waits, regresiones y plan forcing reversible.", ["query store", "plan", "runtime stats", "wait", "regresión", "forcing", "rendimiento"]),
  r("sqlserver-backup", "Back up and restore SQL Server databases", "https://learn.microsoft.com/en-us/sql/relational-databases/backup-restore/back-up-and-restore-of-sql-server-databases?view=sql-server-ver17", "Microsoft", "official-docs", "SQL Server 2025 (17.x)", "Recovery models, cadenas full/differential/log, restauración y point-in-time recovery.", ["backup", "restore", "recovery model", "point-in-time", "tail-log", "integridad"]),
  r("sqlserver-always-on", "Always On availability groups", "https://learn.microsoft.com/en-us/sql/database-engine/availability-groups/windows/overview-of-always-on-availability-groups-sql-server?view=sql-server-ver17", "Microsoft", "official-docs", "SQL Server 2025 (17.x)", "Réplicas, modos de disponibilidad, listeners, sincronización y failover.", ["always on", "availability group", "réplica", "failover", "synchronized", "alta disponibilidad"]),
  ...
  r("aws-s3", "Amazon S3 User Guide", "https://docs.aws.amazon.com/AmazonS3/latest/userguide/Welcome.html", "Amazon Web Services", "official-docs", "Rolling", "Buckets, objetos, claves, seguridad, Block Public Access, almacenamiento y operación.", ["s3", "bucket", "object", "key", "block public", "storage", "sync"]),
  r("aws-cloudfront", "Amazon CloudFront Developer Guide", "https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/Introduction.html", "Amazon Web Services", "official-docs", "Rolling", "Distribuciones, orígenes privados, OAC, behaviors, cache keys, HTTPS e invalidaciones.", ["cloudfront", "oac", "origin access", "cache", "invalidation", "behavior", "edge", "https"]),
  r("aws-lambda", "AWS Lambda Developer Guide", "https://docs.aws.amazon.com/lambda/latest/dg/welcome.html", "Amazon Web Services", "official-docs", "Rolling", "Handlers, eventos, entornos de ejecución, concurrencia, permisos, observabilidad y despliegue.", ["lambda", "handler", "cold start", "concurrency", "event", "execution role", "serverless"]),
  r("aws-apigateway", "Amazon API Gateway Developer Guide", "https://docs.aws.amazon.com/apigateway/latest/developerguide/welcome.html", "Amazon Web Services", "official-docs", "Rolling", "Rutas, integraciones, stages, authorizers, payloads y operación de APIs.", ["api gateway", "route", "integration", "stage", "authorizer", "jwt", "payload"]),
  r("aws-dynamodb", "Amazon DynamoDB Developer Guide", "https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/Introduction.html", "Amazon Web Services", "official-docs", "Rolling", "Items, claves, access patterns, Query, Scan, índices, consistencia, capacidad y transacciones.", ["dynamodb", "partition key", "sort key", "query", "scan", "gsi", "consistency", "capacity", "idempot"]),
  r("aws-cloudwatch", "Amazon CloudWatch User Guide", "https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/WhatIsCloudWatch.html", "Amazon Web Services", "official-docs", "Rolling", "Logs, métricas, EMF, dashboards, alarmas, Logs Insights y respuesta operativa.", ["cloudwatch", "log", "metric", "emf", "alarm", "insights", "dashboard", "runbook", "p95"]),
  r("aws-costs", "AWS Cost Management User Guide", "https://docs.aws.amazon.com/cost-management/latest/userguide/what-is-costmanagement.html", "Amazon Web Services", "official-docs", "Rolling", "Cost Explorer, Budgets, allocation tags, reportes, alertas y optimización FinOps.", ["cost explorer", "budget", "cost", "tag", "finops", "alert", "forecast", "gasto"]),
...
const baseProfiles: readonly CollectionReferenceProfile[] = [
  ...
  p("prolog", ["iso-prolog-core", "swi-prolog-manual"], ["iso-prolog-core", "iso-prolog-modules", "iso-prolog-dcg", "swi-prolog-manual", "swi-prolog-clpfd", "swi-prolog-tabling"]),
  p("mediapipe", ["mediapipe-python-setup", "mediapipe-tasks-api"], ["mediapipe-release", "mediapipe-pypi", "mediapipe-python-setup", "mediapipe-python-api", "mediapipe-tasks-api", "mediapipe-gesture", "opencv-python", "python-tutorial"]),
  p("xml", ["xml10", "xml-names10"], ["xml10", "xml-names10", "xml-infoset", "xml-base", "xinclude11", "xpath31", "xslt30", "xml-c14n11", "xmldsig11", "xmlenc11", "rfc7303", "owasp-xxe"]),
  p("xsd", ["xsd11-structures", "xsd11-datatypes"], ["xsd10-structures", "xsd11-structures", "xsd11-datatypes", "xml10", "xml-names10", "xml-infoset", "xpath31"]),
  p("json", ["rfc8259", "json-schema-core"], ["rfc8259", "ecma404", "json-schema-core", "json-schema-validation", "rfc6901", "rfc6902", "rfc7386", "rfc7464", "rfc7493", "rfc8785", "rfc9535", "jsonld11"]),
  ...
  p("sql-server", ["sqlserver-docs", "sqlserver-tsql"], ["sqlserver-docs", "sqlserver-tsql", "sqlserver-internals", "sqlserver-locking", "sqlserver-query-store", "sqlserver-backup", "sqlserver-always-on"]),
  ...
  p("aws", ["aws-waf", "aws-iam"], ["aws-waf", "aws-iam", "aws-cloudformation", "aws-orgs", "aws-endpoints", "aws-s3", "aws-cloudfront", "aws-lambda", "aws-apigateway", "aws-dynamodb", "aws-cloudwatch", "aws-costs", "otel"]),
